...
// results format
  ...
  onSubmit(newcase) {
    ...
    const body = {
      ...
      FORCEDSALEVALUE: newcase.value.forcedsalevalue,
      OPENMARKETVALUE: newcase.value.openmarketvalue,
    ...
    console.log(body);
    this.ecolService.newmarketor(body).subscribe(resp => {
  ...
  formBuilder() {
    this.newcase = new FormGroup({
      ...
      'forcedsalevalue' : new FormControl(null, Validators.required),
      'openmarketvalue' : new FormControl(null, Validators.required),
