...
// results format
  ...
  onSubmit(newcase) {
    ...
    const body = {
      ...
      ACCBALANCE: newcase.value.accbalance,
      VEHICLEREGNO: newcase.value.vehicleregno,
      FILENO: newcase.value.fileno,
    ...
    console.log(body);
    this.ecolService.newyard(body).subscribe(resp => {
      swal('Success!', 'Update successful!', 'success');
      this.spinner.hide();
      newcase.reset(); // clears the form
      this.router.navigate(['/yards/allcases']);
      // this.getData();
